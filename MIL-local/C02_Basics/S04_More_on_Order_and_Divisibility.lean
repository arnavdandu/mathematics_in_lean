...
example : min (min a b) c = min a (min b c) := by
  have h₁ : ∀ x y z : ℝ, min (min x y) z ≤ min y z := by
    intro x y z
    apply le_min
    . apply le_trans
      apply min_le_left
      apply min_le_right
    apply min_le_right
  have h₂ : ∀ x y z : ℝ, min x (min y z) ≤ min x y := by
    intro x y z
    apply le_min
    . apply min_le_left
    apply le_trans
  ...
  have h : ∀ x y z : ℝ, min (min x y) z ≤ min x (min y z) := by
    ...
    . apply le_trans
      ...
      apply min_le_left
    apply h₁
  have h' : ∀ x y z : ℝ, min x (min y z) ≤ min (min x y) z := by
    intro x y z
    apply le_min
    . apply h₂
    apply le_trans
...
theorem aux : min a b + c ≤ min (a + c) (b + c) := by
  have h₁ : ∀ x y z : ℝ, min x y + z ≤ x + z := by
    ...
    apply min_le_left
  have h₂ : ∀ x y z : ℝ, min x y + z ≤ y + z := by
    intro x y z
    apply add_le_add_right
    apply min_le_right
  apply le_min
